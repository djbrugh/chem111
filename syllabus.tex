%----------------------------------------------------------------------------
% Course Syllabus for Chemistry 111 (c) 2015 by Dale J. Brugh
...
\hypersetup{
    ...
    pdftitle={Course Syllabus: Chemistry 111 / Spring 2015}, 
...
\makeoddhead{courseinformation}%
    {\sffamily Course Syllabus: Chemistry 111 / Spring 2015}{}{\sffamily\thepage}
...
\begin{enumerate}[1.]
\item \marginnote{0.1in}{Several textbooks are supported. See the course website for details.} \textit{General Chemistry: The Central Science} by Brown, LeMay, Bursten, Murphy, and Woodward, Twelfth Edition, Pearson, 2012. ISBN: 9780321696724. 
\item Subscription to \href{http://www.pearsonmylabandmastering.com/northamerica/masteringchemistry/}{MasteringChemistry}. 
...
This course is primarily lecture-based. Each lecture meeting has a topic and an assigned reading which can be found on the course website. A quiz and exercise assignment are assigned after most MWF lecture meetings. Quizzes are available on \href{http://www.pearsonmylabandmastering.com/northamerica/masteringchemistry/}{MasteringChemistry} and are worked and graded there. Exercise assignments are available on the course website and must be worked on paper before being submitted for grading. Due dates are available on the course website. The routine for the entire semester will be to read the assigned readings, come to lecture, work the quizzes and exercises, and repeat for 15 weeks. This general pattern will be interrupted periodically for micro exams and exams to assess your progress. 
%
% --- THINGS I GRADE ---
%
\section{Things I Grade}
You \marginnote{-0.1in}{Due dates for all evaluated items are listed on the course website.} and I determine your progress in this course using the scores derived from evaluating the quality and accuracy of your answers to questions posed in exercise assignments, quizzes, micro exams, and exams. This section provides details for each of these.
%
% --- Exercise Assignments ---
%
\subsection{Exercise Assignments}
Exercise \marginnote{-0.1in}{Worth 15\% of course score. Lowest 6 scores are dropped.} assignments are assigned after most MWF lecture meetings and consist of two problems that I write. You can download them from the course website. For each exercise assignment you are to write out solutions on paper. These hand-written solutions will be turned in at the start of the lecture meeting at which they are due. Solutions will be available on the course website after the assignment is turned in. Exercise assignments are worth 10 points each. Your lowest six (6) exercise assignment scores are dropped before calculating your course score. You are encouraged to work with other students while completing exercise assignments. 
%
% --- Quizzes ---
%
\subsection{Quizzes} 
Quizzes \marginnote{-0.1in}{Worth 15\% of course score. Lowest 6 scores are dropped.} are assigned on \href{http://www.pearsonmylabandmastering.com/northamerica/masteringchemistry/}{MasteringChemistry} after most MWF lectures. Each quiz consists of optional practice questions for no credit, required questions for credit, and optional questions for extra credit. Quizzes will consist of a varying number of questions, but each will be weighted equally at 100 points each. Solutions for quiz questions are available only on \href{http://www.pearsonmylabandmastering.com/northamerica/masteringchemistry/}{MasteringChemistry}. Your lowest six (6) quiz scores are dropped before calculating your course score. You are encouraged to work with other students while completing quizzes.  
%
% --- Micro Exams ---
%
\subsection{Micro Exams}
Micro \marginnote{-0.1in}{Worth 15\% of course score. Lowest single score is dropped. Four micro exams are given.} exams are short exams given during the first 20 minutes of a normal class meeting. Each is worth 25 points. The material covered on each micro exam and the date of each can be found on the course website. Solutions for micro exams are posted on the course website after they are graded. Your single lowest micro exam score is dropped before calculating your final course score. 
%
% --- Exams ---
%
\subsection{Exams}
\marginnote{-0.1in}{Worth 24\% of course score. Three exams are given.} 
Three exams are given during the semester; each is worth 100 points. Exams begin at 7:30 a.m. before a normal class meeting and end at 8:50 a.m. for a total of 80 minutes. The material covered on each exam and the date of each are listed on the course website. Solutions are posted on the course website after all exams have been graded. 
%
% --- Final Exam ---
%
\subsection{Final Exam}
The \marginnote{-0.1in}{Worth 20\% of course scores.} final exam is cumulative over the entire semester and is given in the three-hour block of time specified by the Registrar. No solutions to the final exam are posted, and you are not allowed to take your final exam with you after I grade it. You may review the grading by making an appointment with me, but you may not take possession of the exam.
%
% --- LABORATORY SCORES ---
%
\section{Laboratory Scores}
Your \marginnote{-0.1in}{Worth 11\% of course score.} laboratory instructor is responsible for evaluating your laboratory work. He or she will assign a score to your laboratory work, and at the end of the course I will convert your laboratory score to a percentage that is included in the computation of your course score. I do not adjust laboratory scores. What you earn as a percentage is what will be included in your course score. 
%
% --- COURSE SCORE ---
%
\section{Course Score}
Your course score is a weighted average of the scores you earn on exams, quizzes, exercise assignments, and laboratory work. These scores are weighted according to the percentages shown in Table~\ref{tab:weights}. Before calculating your course score, I will throw away your lowest one (1) micro exam score, your lowest six (6) exercise assignment scores, and your lowest six (6) quiz scores. 
%
...
Exercise Assignments & 15\% & Micro Exams & 15\% \\
Quizzes & 15\% & Exams & 24\% \\
Laboratory & 11\% & Final Exam & 20\% \\ 
\hline\hline
\end{tabular}
\end{table}
%
